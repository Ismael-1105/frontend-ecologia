            ...
            createTheme({
                palette: {
                    ...
                    ...(mode === 'light'
                        ...
                        : {
                            // Dark mode colors - Soft Charcoal Theme (Less Reflective)
                            primary: {
                            ...
                            background: {
                                default: '#0f1410', // Very dark charcoal with green tint (non-reflective)
                                paper: '#1a1f1a', // Dark charcoal (matte finish)
                            },
                            text: {
                                primary: '#e8ebe4', // Light sage
                                secondary: '#b8bdb3', // Muted light sage
                            },
                            divider: 'rgba(163, 181, 132, 0.12)', // Subtle green divider
                        }),
                },
                typography: {
